          ...
          <main className="h-full overflow-y-auto snap-y snap-mandatory scrollbar-hide scroll-smooth">
            ...
            <section id="profile" className="h-screen w-full snap-start">
              <div className="flex justify-center items-center h-full relative">
                ...
                <div className="absolute inset-0 bg-topograph transition-all duration-500 group-hover:opacity-70 group-hover:scale-105 z-0 transform" />
                ...
                <div className="relative z-10 ">
                  ...
                  <div className="row-span-3 p-10 ml-20 mt-20 space-y-5">
